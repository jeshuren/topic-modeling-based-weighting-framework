function prediction = AdaCx_WeightingFramework (TRAIN,TEST,WeakLearn,Type)
...
costs = prob_doc;
costs(1:pos_size) = prob_doc(1:pos_size).*imbalance_ratio;
costs(pos_size+1:end) = prob_doc(pos_size+1:end);
