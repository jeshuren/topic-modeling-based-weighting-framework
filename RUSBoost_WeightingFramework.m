function prediction = RUSBoost_WeightingFramework (TRAIN,TEST,WeakLearn)
...
while t <= T
    ...
    RESAM_NEG = NEG_DATA(randsample(length(NEG_DATA),neg_equal_size,true,W(t,pos_size+1:end)),:);
